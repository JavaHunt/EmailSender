...
setup(
  name = 'EmailSender',         # How you named your package folder (MyLib)
  packages = ['EmailSender'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/JavaHunt/EmailSender/archive/refs/tags/0.1.tar.gz',    # I explain this later on
